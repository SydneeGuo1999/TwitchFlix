...
public record TypeGroupedItemList(
    ...
    public TypeGroupedItemList(String gameId, List<Stream> streams,
                               List<Video> videos, List<Clip> clips) {
        this(
          fromStrems(streams),
    ...
    private static List<ItemEntity> fromStrems(List<Stream> streams) {
